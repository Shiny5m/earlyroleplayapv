...
### **Artikel 1: Cheats (Straf-categorie: 10)**
...
### **Artikel 3: Alt Characters (Straf-categorie: 10)**
   - Onder een alt character wordt verstaan dat een persoon meerdere accounts aanmaakt om binnen de stad Early Roleplay te spelen.
   ...
   - Het is niet toegestaan te spoofen om op die manier weer toegang te krijgen tot je account op Early Roleplay.


### **Artikel 3A: Startersgeld (Straf-categorie: 10)**
...
### **Artikel 7: Karakter breken / OOC (Straf-categorie: 1)** 
   ...
   - Het is alleen toegestaan om de Nederlandse/Engelse taal te spreken/typen in de stad Early Roleplay. (Uitzonderlijke situaties moeten bij een stafflid aangevraagd worden)
...
### **Artikel 15: Metagamen (Straf-categorie: 3)**
   - Informatie verkregen buiten het karakter om (alle informatie die niet verkregen is door jouw karakter binnen Early Roleplay) mag niet gebruikt worden door het karakter, denk daarbij aan info die je via discord verkregen heb, buiten de daarvoor bestemde kanalen.
   - Wanneer je in Early Roleplay bent is het verboden om te screen sharen.
   - Het praten in call tijdens een scenario zal als metagamen worden gezien. Wanneer je met meerdere mensen op Early Roleplay speelt is het verplicht om jezelf te muten tijdens scenario's.
   - Het versturen van ingame informatie in de Early Roleplay onderwereld discord wordt gezien als meta.
   - Als je Early Roleplay streamt moet deze altijd openbaar zijn. Privéstreamen is verboden.
...
- Voor RDM, metagaming en combatloggen hoef je geen report aan te maken. Hiervoor dien je een ticket aan te maken in de support Discord van Early Roleplay.
...
- Tijdens het spelen van de stad Early Roleplay, is het vereist om de Nederlandse taal te beheersen en toe te passen.
...
- Voor specificaties en extra informatie staan alle regels omtrent gangwars in de Early Roleplay Onderwereld Discord bij het kanaal [Gang-regels](https://discordapp.com/channels/777512381688709200/777515986567692308)
...
- Vanaf 10 leden is het verplicht om in een discord te zitten van Early Roleplay, deze dient direct aangevraagd te worden via een ticket!
...
- Je bent als streamer een visitekaartje voor Early Roleplay. Mochten er dingen gebeuren, laat het ons weten via een ticket.
...
- De naam Early Roleplay moet in de titel van de stream staan zodat het ook door ons gevonden kan worden.
- Early Roleplay in een kwaad daglicht zetten in je stream zal resulteren in een ban.
